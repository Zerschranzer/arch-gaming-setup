...
main_installation() {
    ...
    lib32-vulkan-icd-loader obs-studio discord flatpak mangohud lib32-mangohud goverlay gamescope solaar bluez bluez-utils pipewire pipewire-pulse pipewire-alsa linux-headers
